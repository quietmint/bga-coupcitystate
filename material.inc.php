...
$this->actions = array(
   ...
   TAX => array(
      ...
      'forbid' => array(),
      'blockers' => array(),
      'variant' => array('variantDiplomat' => 0),
   ),
   COOPERATION => array(
      ...
      'logAttempt' => clienttranslate('${player_name} claims the ${card_name} to cooperate with ${player_name2}...'),
      'logExecute' => clienttranslate('${player_name} takes ₤${amount} as cooperation.'),
      'target' => true,
      'cost' => 0,
      'amount' => 3,
      'character' => DIPLOMAT,
      'forbid' => array(),
      'blockers' => array(),
      'variant' => array('variantDiplomat' => 1),
   ),
   STEAL => array(
...
$this->characters = array(
   ...
   DIPLOMAT => array(
      'name' => clienttranslate('Diplomat'),
      'text' => array(clienttranslate('Take ₤3.'), clienttranslate('Give ₤1 to another player.'), clienttranslate('Blocks foreign aid.')),
      'variant' => array('variantDiplomat' => 1),
   ),
   ASSASSIN => array(
