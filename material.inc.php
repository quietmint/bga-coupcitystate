...
$this->actions = array(
    INCOME => array(
       ...
       'icon' => 'mdi-cash',
       'text' => array(clienttranslate('Take ₤1.')),
       'balloonAttempt' => '',
       'logAttempt' => '',
    ...
    FOREIGN_AID => array(
       ...
       'icon' => 'mdi-gift',
       'text' => array(clienttranslate('Take ₤2.')),
    ...
    COUP => array(
       ...
       'text' => array(clienttranslate('Pay ₤7.'), clienttranslate('Choose player to lose influence.')),
       'balloonAttempt' => '',
       'logAttempt' => '',
    ...
    CONVERT => array(
       ...
       'text' => array(clienttranslate('Pay almshouse.'), clienttranslate('Choose player to change faction.')),
       'balloonAttempt' => '',
       'logAttempt' => '',
    ...
    EMBEZZLE => array(
       ...
       'icon' => 'mdi-home-heart',
       'text' => array(clienttranslate('Steal from almshouse.')),
    ...
    TAX => array(
       ...
       'icon' => 'mdi-seal',
       'text' => array(clienttranslate('Take ₤3.')),
    ...
    STEAL => array(
       ...
       'icon' => 'mdi-anchor',
       'text' => array(clienttranslate('Steal ₤2 from another player.')),
    ...
    EXCHANGE => array(
       ...
       'text' => array(clienttranslate('Exchange 2 cards with the deck.')),
    ...
    EXCHANGE1 => array(
       'name' => clienttranslate('Exchange'),
       'icon' => 'mdi-swap-horizontal',
       'text' => array(clienttranslate('Exchange 1 card with the deck.')),
       'balloonAttempt' => clienttranslate('I will exchange cards...'),
       'logAttempt' => clienttranslate('${player_name} claims the ${card_name} to exchange cards...'),
       'logExecute' => clienttranslate('${player_name} draws ${count} cards from the deck.'),
       'target' => false,
    ...
    EXAMINE => array(
       ...
       'icon' => 'mdi-incognito',
       'text' => array(clienttranslate('Choose player to view card (may force exchange).')),
